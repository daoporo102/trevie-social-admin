...
class _PostsListScreenState extends State<PostsListScreen> {
  ...
  bool _isDeletingPost = false; // add this state field near other booleans like _isLoading/_isLoadingMore
  int _totalPosts = 0;
  ...
  DataRow2 _buildDataRow(Post post) {
    ...
    return DataRow2(
      cells: [
        ...
        DataCell(
          post.postUrls.isNotEmpty
              ? GestureDetector(
                  onTap: () {
                    // Show fullscreen gallery when clicked
                    _showImageGallery(context, post.postUrls);
                  },
                  child: SizedBox(
                    width: 100,
                    height: 60,
                    child: Stack(
                      children: [
                        ...
                        // Overlay gradient if multiple images
                        if (post.postUrls.length > 1)
                          Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(6),
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Hình ảnh bài viết (${imageUrls.length})',
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: primaryTextColor,
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          // Show single image fullscreen
                          _showSingleImage(dialogContext, imageUrls, index);
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8),
